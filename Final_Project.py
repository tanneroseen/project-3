...
#We use Streamlit to create our webapp
#This code will not run on Streamlit without another file called requirements.txt with the names of required modules
...
now = dt.now(pytz.timezone('Canada/Mountain')).strftime('%B %d, %Y %I:%M:%S %p')  #Gets the current date and time
...
st.write('''
    ...
    4. Vecteezy. (n.d.). Vecteezy. Retrieved December 6, 2022, from https://www.vecteezy.com/ \n
''')
